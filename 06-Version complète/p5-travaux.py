...
class CommandeApp(tk.Tk):
    ...
    def export_to_text(self):
        """Exporter le contenu de la Treeview dans un fichier texte avec un nom par défaut."""
        # Définir un nom de fichier par défaut basé sur un paramètre comme l'année ou la date actuelle
